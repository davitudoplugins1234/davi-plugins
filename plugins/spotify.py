...
@kannax.on_cmd("spotify$", about={"header": "Música que está ouvindo agora"})
...
@kannax.on_cmd("spinfo", about={"header": "Informações sobre as músicas e o aparelho"})
...
@kannax.on_cmd("sperfil", about={"header": "Informações de sua Conta do Spotify"})
...
@kannax.on_cmd("sprecentes", about={"header": "Suas músicas tocadas recentemente"})
